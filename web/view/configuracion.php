...
<head>
  ...
  <script src='../scripts/Aplicacion/class/jsClassConfiguracion.js'></script>
...
<body class="bg-light">
      ...
      <div class="col-md-9">
        ...
        <div class="card">
          <div class="card-header">
            <h5>Configuración de la sonda en el lago</h5>
          </div>
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="ddlSensor">Sonda</label>
  ...
  <input type="hidden" id="textLagoSensorID" value="" hidden />
